...
class RunawayGame:
    ...
    def is_catched(self):
        ...
        is_catched = dx**2 + dy**2 < self.catch_radius2
        if(is_catched):
            self.gameEnd = time.time() - self.gameStart
        return is_catched
    ...
    def step(self):
        ...
        self.drawer.write(f'Is catched? {is_catched}\nTime : {time.time()-self.gameStart:.3f}')
        if(is_catched):
            turtle.done()
            self.drawer.undo()
            self.drawer.write(f'Time : {self.gameEnd:.3f}')
...
class RandomMover(turtle.RawTurtle):
    ...
    def run_ai(self, opp_pos, opp_heading):
        ...
        if mode == 0:
            ...
            if(self.pos()[0] < -350) or (self.pos()[0] > 350) or (self.pos()[1] < -350) or (self.pos()[1] > 350):
                turtle.done()
        elif mode == 1:
